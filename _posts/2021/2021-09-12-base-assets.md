...
Por exemplo, sobre o [criando o blog]({% post_url 2021/2021-08-30-criando-blog-jekyll %}), usei a pasta
...
`{{ "%7B%25 post_url 2021/2021-08-30-criando-blog-jekyll %25%7D" | url_decode }}`. Daí,
com isso, posso apontar [pro post original]({% post_url 2021/2021-08-30-criando-blog-jekyll %}).
Ou então para [este atual post]({% post_url 2021/2021-09-12-base-assets %}).