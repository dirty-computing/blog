...
Fiz o seguinte post: [Atualizando o SASS do Computaria]({% post_url 2025/2025-01-29-updating-sass %}).
...
script criado em
[Movendo de draft para post]({% post_url 2021/2021-12-28-publish-draft %}). Vamos
