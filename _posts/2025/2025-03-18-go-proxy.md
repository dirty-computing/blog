...
> [um post sobre HTTP]({% post_url 2025/2025-03-13-o-dia-que-estudei-http %}), mas o
...
[O dia em que precisei estudar HTTP, para otimizar a aplicação]({% post_url 2025/2025-03-13-o-dia-que-estudei-http %}).
