...
[Editando SVG na mão pra pedir café]({% post_url 2024-03-16-edita-svg-manualmente %})
...
[Rascunhos publicados em Jekyll]({% post_url 2022-10-26-public-draft %}))
...
- o índice
- a página de tags ([Usando as tags - Parte 1: página de tags]({% post_url 2024-06-03-pagina-tags %}))
