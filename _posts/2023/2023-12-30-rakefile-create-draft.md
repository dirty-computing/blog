...
2023/2023-01-06-rakefile-publish-draft %}). Agora, vamos focar
na criação de rascunhos e na menção de imagens.

Apenas para recordar, esse artigo é a segunda parte de 3:

Na [primeira parte]({% post_url 2023/2023-01-06-rakefile-publish-draft %}) tivemos:

1. apanhado geral do Rakefile
1. rodar o Jekyll
1. fazer a ação de publicar (leia artigo [Movendo de draft para post]({% post_url 2021/2021-12-28-publish-draft %}))

Na parte 2 teremos:

1. regras e patterns simples
1. criar um novo post (leia artigo [Criando posts com Makefile]({% post_url 2022/2022-10-16-new-post %}))
1. pegar menção de imagem (leia artigo [Automatizando menção de imagem]({% post_url 2022/2022-10-19-automatizando-mencao-imagem %}))
...
Pegando a ideia do [criando posts com Makefile]({% post_url 2022/2022-10-16-new-post %}),
