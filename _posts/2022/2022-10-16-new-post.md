...
- `base-assets`: sempre no format `/assets/RDX/`, se tiver assets, vide [`base-assets`]({% post_url 2021/2021-09-12-base-assets %})
...
Seguindo o exemplo do [`publish-draft`]({% post_url 2021/2021-12-28-publish-draft %}), vou forçar
