...
[Rakefile, parte 2 - criando rascunho]({% post_url 2023/2023-12-30-rakefile-create-draft %})?
Que foi o último meta-post até o momento?

Vamos lá. Estou citando dessa maneira: `{%- raw -%}{% post_url 2023/2023-12-30-rakefile-create-draft %}{% endraw %}`. Primeiro eu não consigo manusear diretamente esse `post_url`, ele é uma tag liquid,
não um filtro. Então eu posso jogar o valor dele em uma variável:

```liquid
{%- raw -%}
{% capture rake2_create %}{% post_url 2023/2023-12-30-rakefile-create-draft %}{% endcapture %}
{% endraw %}
```
