...
a versão usada no [Editando SVG na mão para pedir café]({% post_url 2024/2024-03-16-edita-svg-manualmente %}).
...
[Colocando coelhinhos no Computaria e enlouquecendo]({% post_url 2024/2024-04-06-colocando-coelhinhos-no-computaria %}),
